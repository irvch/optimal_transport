...
for i = 1:20
    ...
    [T_hist, L1_hist, L2_hist, L_hist, eta_hist, iter] = grad_descent(x, y, eta_init, beta1, beta2, iter_num, H_const, lambda_init, lambda_final, alpha);
...
function [eta, Tx_next, m_next, v_next] = adapt_learning(x, y, Tx_curr, Hx, Hy, lam, eta, m_curr, v_curr, beta1, beta2, iter)
...
% GRADIENT DESCENT
function [T_hist, L1_hist, L2_hist, L_hist, eta_hist, i] = grad_descent(x, y, eta, beta1, beta2, iter_num, H_const, lam_init, lam_final, alpha)
    ...
    %for i = 1:iter_num
        ...
        [eta, Tx, m, v] = adapt_learning(x, y, Tx, Hz, Hz, lam, eta, m, v, beta1, beta2, i);
