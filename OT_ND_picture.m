...
x = double(im2gray(imread('Tree1.png')));
y = double(im2gray(imread('Tree2.png')));
...
lambda_init = 1000000;    % INITIAL REGULARIZATION PARAMETER 
lambda_final = 10000000;  % FINAL REGULARIZATION PARAMETER (SHOULD ALWAYS INCREASE)
